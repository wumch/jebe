...
iptables -t nat -A PREROUTING -p tcp -s 124.207.235.2 -d 211.154.172.172 --dport 58098 -j DNAT --to 192.168.88.1:58098
...
iptables -t nat -A PREROUTING -p tcp -s 124.207.235.2 -d 211.154.172.172 --dport 50011 -j DNAT --to 192.168.88.1:50011
