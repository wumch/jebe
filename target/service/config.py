...
#        'tcp://192.168.88.3:10015',
    ...
    mongodbs = {
        'text' : {'host':'192.168.8.2', 'port':27017, 'max_pool_size':50, 'network_timeout':5, 'socketTimeoutMS':1000},
        'loc' : {'host':'192.168.8.4', 'port':27017, 'max_pool_size':50, 'network_timeout':5, 'socketTimeoutMS':1000},
    }
