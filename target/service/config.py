...
#        'tcp://192.168.88.3:10015',
    ...
    mongodbs = {
        'text' : {'db':'srv2-text', 'param':{'host':'192.168.88.2', 'port':27017, 'max_pool_size':50, 'network_timeout':5, 'socketTimeoutMS':1000, }},
        'loc' : {'db':'srv4-loc', 'param':{'host':'192.168.88.4', 'port':27017, 'max_pool_size':50, 'network_timeout':5, 'socketTimeoutMS':1000, }},
    }
