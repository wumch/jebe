...
class Config(object):
    ...
    mongodbs = {
        'text' : {'db':'text', 'collection':'main', 'param':{'host':'192.168.88.2', 'port':27011, 'max_pool_size':5, 'network_timeout':5, 'socketTimeoutMS':1000, }},
        ...
        'paths' : {'db':'paths', 'collection':'main', 'param':{'host':'192.168.88.1', 'port':27012, 'max_pool_size':5, 'network_timeout':5, 'socketTimeoutMS':1000, }},
...
#            'text' : {'db':'text', 'collection':'main', 'param':{'host':'127.0.0.1', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':1000, }},
            'text' : {'db':'text', 'collection':'main', 'param':{'host':'211.154.172.172', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':10000, }},
            'loc' : {'db':'loc', 'collection':'main', 'param':{'host':'127.0.0.1', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':10000, }},
            'paths_old' : {'db':'paths_old', 'collection':'main', 'param':{'host':'127.0.0.1', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':10000, }},
            'paths' : {'db':'paths', 'collection':'main', 'param':{'host':'127.0.0.1', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':10000, }},
            'crawlqueue' : {'db':'crawlqueue', 'collection':'main', 'param':{'host':'127.0.0.1', 'port':27017, 'max_pool_size':2, 'network_timeout':5, 'socketTimeoutMS':10000, }},
        }
        iothreads = 1
