...
__config = {
    ...
    'mysql' : { 'host' : 'localhost', 'port' : 3306, 'user' : 'root', 'password' : 'IGetTheWorld54612', 'database' : 'mgc', 'charset' : 'utf8', 'datapath':'/data/etc/mysql5/data'},
    ...
    'path' : { 'web' : '/data/www/haifeng.li/mgc/', 'tracelog' : '' }
}
